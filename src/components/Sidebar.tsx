...
export function Sidebar({ activeSection, onSectionChange, isAuthenticated }: SidebarProps) {
  ...
  return (
    <>
      ...
      {/* Floating toggle button when collapsed - positioned outside sidebar */}
      {isCollapsed && (
        <button
          onClick={toggleSidebar}
          className="fixed top-4 left-4 z-50 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-full p-2 shadow-lg hover:shadow-xl transition-shadow"
        >
